...
@foreach ($navItems as $item)
    @php
        ...
        $routeHasSection = substr_count($item['route'], '.') >= 2;
        $activePrefix = $routeHasSection ? str($item['route'])->beforeLast('.')->append('.') : null;
        $isActive =
            $currentRoute === $item['route'] ||
            ($activePrefix && str_starts_with((string) $currentRoute, (string) $activePrefix));
    @endphp
